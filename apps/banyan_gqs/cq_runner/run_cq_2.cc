...
#include "cq_queries/cq_2/cq2_executor.hh"
...
int main(int ac, char** av) {
    ...
    at_cq = true;
    initialize_log_env(std::string(banyan_gqs_dir) + "/results/logs/cq_2.log");
    cq2_helper.load_cq_params();
    ...
    finalize_log_env();
    std::cout << "[Exec finished] Results have been writen into apps/banyan_gqs/results/logs/cq_2.log\n";
    return 0;
}