...
void cq5_op_0_V_loopEnter::trigger(StartVertex&& src) {
    _src_vertex = src.val;
...
seastar::future<TrivialStruct<bool> > cq5_op_0_V_loopEnter::set_params(VertexBatch &&input) {
...
void cq5_op_0_V_loopEnter::finalize() {
