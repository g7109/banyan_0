...
thread_local std::unordered_set<int64_t> cq5x_op_1x1_loopUntil::_successful_vertices{};
thread_local std::unordered_set<int64_t> cq5x_op_1x1_loopUntil::_failed_vertices{};

void cq5x_op_1x1_loopUntil::process(VertexBatch &&input) {
...
void cq5x_op_1x1_loopUntil::receive_eos(Eos &&eos) {
    _notify_ds |= eos.val;
...
void cq5x_op_1x1_loopUntil::initialize() {
...
void cq5x_op_1x1_loopUntil::finalize() {
