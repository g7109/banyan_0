...
#include "cq6x_op_0_V_loopEnter.act.h"

inline void exec_cq6x(int64_t start_vertex) {
    write_log(seastar::format(
            "[Exec CQ 6x] query id = {}, start vertex = {}\n",
    ...
    auto actor_ref_V = builder.build_ref<i_cq6x_op_0_V_loopEnter>(0);
