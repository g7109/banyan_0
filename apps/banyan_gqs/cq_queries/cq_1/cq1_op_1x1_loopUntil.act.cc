...
void cq1_op_1x1_loopUntil::process(VertexBatch&& input) {
...
void cq1_op_1x1_loopUntil::receive_eos(Eos&& eos) {
    _notify_ds |= eos.val;
...
void cq1_op_1x1_loopUntil::initialize() {
...
void cq1_op_1x1_loopUntil::finalize() {
