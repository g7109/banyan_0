...
void cq6_op_1x3_loopUntil::process(VertexBatch&& input) {
...
void cq6_op_1x3_loopUntil::receive_eos(Eos&& eos) {
    _notify_ds |= eos.val;
...
void cq6_op_1x3_loopUntil::initialize() {
...
void cq6_op_1x3_loopUntil::finalize() {
