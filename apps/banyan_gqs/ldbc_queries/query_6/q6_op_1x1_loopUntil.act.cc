...
void q6_op_1x1_loopUntil::process(VertexBatch &&input) {
...
void q6_op_1x1_loopUntil::receive_eos(Eos &&eos) {
    _notify_ds |= eos.val;
...
void q6_op_1x1_loopUntil::initialize() {
...
void q6_op_1x1_loopUntil::finalize() {
