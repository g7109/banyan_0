...
void q9_op_1x1_loopUntil::process(VertexBatch &&input) {
...
void q9_op_1x1_loopUntil::receive_eos(Eos &&eos) {
    _notify_ds |= eos.val;
...
void q9_op_1x1_loopUntil::initialize() {
...
void q9_op_1x1_loopUntil::finalize() {
