...
void q5_op_2_union_out::process(VertexBatch &&input) {
...
void q5_op_2_union_out::receive_eos(Eos &&eos) {
    _notify_ds |= eos.val;
...
void q5_op_2_union_out::initialize() {
...
void q5_op_2_union_out::finalize() {
