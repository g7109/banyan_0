...
#include "ldbc_queries/query_3/q3_executor.hh"

int main(int ac, char** av) {
    auto remaining_args = configure(ac, av);
    at_ic = true;
    initialize_log_env(std::string(banyan_gqs_dir) + "/results/logs/ic_3.log");
    q3_helper.load_benchmark_params();
    ...
    finalize_log_env();
    std::cout << "[Exec finished] Results have been writen into apps/banyan_gqs/results/logs/ic_3.log\n";
    return 0;
}
