...
#include "ldbc_queries/query_8/q8_executor.hh"

int main(int ac, char** av) {
    auto remaining_args = configure(ac, av);
    at_ic = true;
    initialize_log_env(std::string(banyan_gqs_dir) + "/results/logs/ic_8.log");
    q8_helper.load_benchmark_params();
    ...
    finalize_log_env();
    std::cout << "[Exec finished] Results have been writen into apps/banyan_gqs/results/logs/ic_8.log\n";
    return 0;
}
