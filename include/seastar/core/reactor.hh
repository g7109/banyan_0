...
public:
    ...
    friend thread_resource_pollfn;
#ifdef BRANE_GPU_RESOURCE_POOL
    class gpu_resource_pollfn;
    friend gpu_resource_pollfn;
#endif
...
private:
    ...
    // [DAIL]
    friend class brane::actor_message_queue;
    friend class brane::coordinator_worker;
    friend class brane::work_thread;
    friend class brane::network_message_queue;
    friend class poller;
